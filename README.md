# CompositeCommandDemo
Shows how to take arbitrary ImageCommands and encapsulate and compose them into one new single ImageCommand.  
Uses reflection to display all image commands in all referenced assemblies.

This is the VB.NET version. A [C# version](https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_CompositeCommandDemo_CS_x64) is also available.  
...
## Downloading source
The sources can be downloaded for [c#](https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_CompositeCommandDemo_CS_x64/archive/refs/heads/main.zip) and [VB.NET](https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_CompositeCommandDemo_VB_x64/archive/refs/heads/main.zip)
...
```bash
git clone https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_CompositeCommandDemo_VB_x64.git CompositeCommandDemo --recursive
cd CompositeCommandDemo
git submodule init
