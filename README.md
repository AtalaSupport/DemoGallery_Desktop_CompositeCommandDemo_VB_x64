...
This is the VB.NET version. A [C# version](https://github.com/AtalaSupport/DemoGallery_Desktop_CompositeCommandDemo_CS_x64) is also available.  
...
## Downloading source
The sources can be downloaded for [c#](https://github.com/AtalaSupport/DemoGallery_Desktop_CompositeCommandDemo_CS_x64/archive/refs/heads/main.zip) and [VB.NET](https://github.com/AtalaSupport/DemoGallery_Desktop_CompositeCommandDemo_VB_x64/archive/refs/heads/main.zip)
...
```bash
git clone https://github.com/AtalaSupport/DemoGallery_Desktop_CompositeCommandDemo_VB_x64.git CompositeCommandDemo --recursive
